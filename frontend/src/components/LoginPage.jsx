...
  // --- START: URL Configuration Update ---
  // FIX: Removed import.meta.env due to compilation errors in the target environment.
  // The URL is now directly set to your required live backend URL.
  const API_ROOT = "https://inbotiq-backend-xkqs.onrender.com";
  // 3. Construct the full Authentication base URL.
  const AUTH_URL = `${API_ROOT}/api/auth`;
  // --- END: URL Configuration Update ---
